...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  getBallance() {
    ...
    // address contract
    // 0x23A602Ab9bE22DaD2bCC5Addd0897a5fd24BC7E6
    const tokenContract = new this.web3.eth.Contract(this.abi, '0x23A602Ab9bE22DaD2bCC5Addd0897a5fd24BC7E6');
    ...
    tokenContract.methods.balanceOf('0xa5c2602e05c33ed6963d9b8130e95ecf7435fafd').call().then(res => console.log('Currency ', currency.name + '| balanceOf (0) = ', res, currency.symbol))
    tokenContract.methods.balanceOf('0x3fb8fe79cd1297819832a72aa24ede816cb69763').call().then(res => console.log('Currency ', currency.name + '| balanceOf (1) = ', res, currency.symbol))
  }

  transfer() {
    const contract = new this.web3.eth.Contract(this.abi, '0x23A602Ab9bE22DaD2bCC5Addd0897a5fd24BC7E6', {from: '0xa5c2602e05c33ed6963d9b8130e95ecf7435fafd'});
    console.log('contract ', contract)
    contract.methods.transfer('0x3fb8fe79cd1297819832a72aa24ede816cb69763', 150).send().then(res => console.log(res))
  }
